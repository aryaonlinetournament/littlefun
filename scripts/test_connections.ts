...
async function checkConnections() {
  ...
  try {
    ...
    console.log(`   ✅ /health status: ${healthRes.status}, data:`, healthData);
  } catch (e: any) {
  ...
  try {
    ...
    console.log(`   ✅ / root status: ${rootRes.status}, API Name:`, rootData.name);
  } catch (e: any) {
  ...
  try {
    ...
    if (fbRes.ok) {
      ...
      console.log(`   ℹ️ Firebase init endpoint responded with status: ${fbRes.status}`);
    }
  } catch (e: any) {
